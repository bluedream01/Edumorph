  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0D162A] to-[#0D162A] flex flex-col items-center justify-start px-4 py-10">
      <div className="w-full max-w-3xl mb-10">
        <Progress value={progressPercent} className="h-2 bg-[#1C2942]" />
      </div>
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 1 && (
          <motion.div key="step-1" {...fadeMotionProps} className="text-center w-full max-w-3xl">
            <div className="bg-[#0F1D37] rounded-2xl p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">Which class are you currently in?</h2>
...
>
  Class {cls}
        ...
        {step === 2 && (
          <motion.div key="step-2" {...fadeMotionProps} className="text-center w-full max-w-3xl">
            <div className="bg-[#0F1D37] rounded-2xl p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">Select your academic board</h2>
        ...
        {step === 3 && (
          <motion.div key="step-3" {...fadeMotionProps} className="text-center w-full max-w-4xl">
            <div className="bg-[#0F1D37] rounded-2xl p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 justify-center">
                {subjects.map((subj) => (
                  <button
                    ...
                    className={`rounded-xl border flex flex-col items-center px-6 py-4 text-sm font-semibold transition-all duration-200 ${selectedSubjects.includes(subj.name)
              ...
              <Button onClick={nextStep} className="mt-6 px-6 py-2 text-lg rounded-xl">
                Next
              </Button>
            </div>
          </motion.div>
        ...
        {step === 4 && (
          <motion.div key="step-4" {...fadeMotionProps} className="text-center w-full max-w-3xl">
            <div className="bg-[#0F1D37] rounded-2xl p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">
              ...
              <Button onClick={nextStep} className="mt-4 px-6 py-2 text-lg rounded-xl">
                Next
              </Button>
            </div>
          </motion.div>
        ...
        {step === 5 && (
          <motion.div key="step-5" {...fadeMotionProps} className="text-center w-full max-w-5xl">
                        ...
                        {topics.length > 0 && (
                          <>
                            ...
                            <div className="grid sm:grid-cols-3 text-sm text-gray-300 gap-4">
                              <p><span className="font-semibold text-white">Learning Path:</span> Structured lessons</p>
                              <p><span className="font-semibold text-white">Recommended:</span> Practice tests</p>
                              <p><span className="font-semibold text-white">AI Quiz:</span> Personalized questions</p>
                            </div>
                          </>
                        )}
                      </div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="secondary" className="w-full sm:w-auto bg-[#1C2942] text-white hover:bg-[#26334f]">
                Edit Preferences
              </Button>
            </div>
          </motion.div>
